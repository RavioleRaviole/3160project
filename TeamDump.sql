...
CREATE TABLE `driver_rating` (
  ...
  `onTime` tinyint DEFAULT NULL,
  `courteous` tinyint DEFAULT NULL,
  PRIMARY KEY (`rating_id`),
  CONSTRAINT `fk_driver_rating_rating1` FOREIGN KEY (`rating_id`) REFERENCES `rating` (`rating_id`)
...
INSERT INTO `driver_rating` VALUES (1,0,1),(2,0,0),(3,0,1),(4,0,1),(5,1,0),(6,1,1),(7,0,1),(8,0,0),(9,0,1),(10,1,1),(11,0,1),(12,0,1),(13,0,0),(14,0,1),(15,0,1),(16,1,1),(17,0,0),(18,1,0),(19,1,1),(20,1,1);
...
CREATE TABLE `rating` (
  `rating_id` int NOT NULL,
  `overall_rate` int DEFAULT NULL,
  `orderId` int NOT NULL,
  PRIMARY KEY (`rating_id`),
  UNIQUE KEY `rating_id_UNIQUE` (`rating_id`),
  KEY `fk_rating_order1_idx` (`orderId`),
  CONSTRAINT `fk_rating_order1` FOREIGN KEY (`orderId`) REFERENCES `order` (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `rating` VALUES (1,5,1),(2,5,2),(3,5,3),(4,5,4),(5,3,5),(6,1,6),(7,1,7),(8,4,8),(9,1,9),(10,5,10),(11,5,11),(12,2,12),(13,2,13),(14,2,14),(15,5,15),(16,2,16),(17,1,17),(18,2,18),(19,2,19),(20,2,20);
...
INSERT INTO `restaurant_rating` VALUES (1,2,4),(2,1,4),(3,2,3),(4,4,2),(5,5,3),(6,4,2),(7,3,3),(8,4,4),(9,2,3),(10,1,1),(11,5,5),(12,2,3),(13,4,4),(14,4,5),(15,2,2),(16,1,4),(17,4,5),(18,2,3),(19,5,5),(20,4,3);
...
-- Dump completed on 2021-04-11 15:22:20
